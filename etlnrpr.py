...
class ETL:
    ...
    def execute(self,zip,prov):
        ...
        merge1,rate,df2,newcsv,provdier=transform_nrpr.trasform_nrpr(new_path,self,prov)
        self.logger.info("Load")

        rate_path,provider_path = process.process_nrpr(merge1,rate,newcsv,provdier)
        
        load_nrpr.load_nrpr(rate_path,provider_path,df2,self)